...
return new class extends Migration {
    ...
    public function up(): void
    {
        Schema::create('order_payments', static function (Blueprint $table) {
            ...
            $table->string('cny_invoice_number')->comment('CNY发票号')->nullable();
            $table->decimal('usd_amount', 10)->comment('美元费用')->default(0);
            $table->string('usd_invoice_number')->comment('CNY发票号')->nullable();
